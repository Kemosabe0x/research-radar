...
2. **Add LLM Summarization:** Instead of just printing the title, you can pipe the `entry.description` (the abstract) into the `google-genai` or `openai` Python SDK. Have the AI read the abstract and generate a 2-sentence summary *before* sending the notification to your Slack/Notion.
