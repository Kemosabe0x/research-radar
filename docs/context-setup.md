...
>
> ```bash
> pip install -e /Users/seansalaman/Cursor-Project-Skills   # or pip install git+https://github.com/<org>/Cursor-Project-Skills.git
> cursor-project-skills apply --profile .cursor/skills-profile.yaml # optional: cursor-project-skills dry-run --preset backend-ui
...
**What they do _not_ do:** remove installed plugins or global skills from the session catalog. Prune at the source below.
...
3. **Dry run** — list what _would_ be archived without moving:
